...
Make a small ReactJS app. Skeleton app is here for you, but please change whatever you want (CSS files, HTML structure, JS structure...).
...
I am using [yarn](https://yarnpkg.com) here:
